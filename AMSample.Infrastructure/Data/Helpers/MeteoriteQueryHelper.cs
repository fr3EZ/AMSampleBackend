namespace AMSample.Infrastructure.Data.Helpers;

public static class MeteoriteQueryHelper
{
    public static IQueryable<Meteorite> ApplyFilters(IQueryable<Meteorite> query, MeteoriteFiltersDto? filters)
    {
    ...
    public static IQueryable<Meteorite> ApplySorting(IQueryable<Meteorite> query, MeteoriteFiltersDto? filters)
    {
    ...
    {
        var groupedQuery = filtersDto.GroupBy switch
        {
        ...
        groupedQuery = ApplyGroupSorting(groupedQuery, filtersDto);
        ...
        return new PaginatedEntity<Meteorite>()
        {
            ...
            EntityGroups = pagedGroups.Select(g => new EntityGroup
            {
                Key = g.Key,
                Count = g.Count,
    ...
    private static IQueryable<EntityGroup> ApplyGroupSorting(
        IQueryable<EntityGroup> groupedQuery,
        MeteoriteFiltersDto? filters)
    {
